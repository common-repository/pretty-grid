...
if ( ! class_exists( 'Pretty_Grid_Field' ) ) :

class Pretty_Grid_Field extends Pretty_Grid_Module {
	...
	public function register_cpt() {
		...
		$labels = array(
			'name'          => $this->get_option('Pretty_Grid_Fields'),
			'singular_name' => $this->get_option('pretty_grid_field')
		);
		...
		register_post_type( 'pretty_grid_fields', $args );
	}
