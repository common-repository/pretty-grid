...
$pretty_grid_slide_rows = isset($settings['pretty_grid_slide_rows']) ? $settings['pretty_grid_slide_rows'] : '1';
?>
<div class="pretty-grid-box-settings-row">
    <div class="pretty-grid-box-settings-col-1">
        <span class="pretty-grid-settings-label"><?php esc_html_e( 'Item columns', Pretty_Grid::DOMAIN ); ?></span>
        <span class="pretty-grid-description"><?php esc_html_e( 'Set item column(s) in different devices.', Pretty_Grid::DOMAIN ); ?></span>
    </div>
...
<div class="pretty-grid-box-settings-row">
    <div class="pretty-grid-box-settings-col-1">
    <span class="pretty-grid-settings-label"><?php esc_html_e( 'Item rows', Pretty_Grid::DOMAIN ); ?></span>
        <span class="pretty-grid-description"><?php esc_html_e( 'Set item row(s) in gallery.', Pretty_Grid::DOMAIN ); ?></span>
    </div>
    <div class="pretty-grid-box-settings-col-2">
                <div>
                    <input
                        type="text"
                        name="pretty_grid_slide_rows"
                        placeholder="<?php esc_html_e( '', Pretty_Grid::DOMAIN ); ?>"
                        value="<?php echo $pretty_grid_slide_rows; ?>"
                        id="pretty_grid_slide_rows"
                        class="pretty-grid-form-control"
                        aria-labelledby="pretty_grid_slide_rows"
                    />
                </div>
    </div>
</div>
...
<div class="pretty-grid-box-settings-row">
    <div class="pretty-grid-box-settings-col-1">
    <span class="pretty-grid-settings-label"><?php esc_html_e( 'Items space', Pretty_Grid::DOMAIN ); ?></span>
        <span class="pretty-grid-description"><?php esc_html_e( 'Space Between Items.', Pretty_Grid::DOMAIN ); ?></span>
    </div>
    <div class="pretty-grid-box-settings-col-2">
                <div>
                    <input
                        type="number"
                        value="<?php if(isset($settings['pretty_grid_space'])){echo $settings['pretty_grid_space'];}else{echo '20';}?>"
                        min="0"
                        class="pretty-grid-form-control"
                        name="pretty_grid_space"
                    />
                </div>
    </div>
</div>
...
<div class="pretty-grid-box-settings-row">
    <div class="pretty-grid-box-settings-col-1">
        <span class="pretty-grid-settings-label"><?php esc_html_e( 'Slide Auto Play', Pretty_Grid::DOMAIN ); ?></span>
