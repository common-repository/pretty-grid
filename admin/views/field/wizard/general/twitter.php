...
<div class="pretty-grid-box-settings-row">
    <div class="pretty-grid-box-settings-col-1">
        <span class="pretty-grid-settings-label"><?php esc_html_e( 'Twitter Username', Pretty_Grid::DOMAIN ); ?></span>
        <span class="pretty-grid-description"><?php esc_html_e( 'Select your twitter username as feed data source.', Pretty_Grid::DOMAIN ); ?></span>
    </div>
    <div class="pretty-grid-box-settings-col-2">
        <div class="pretty-grid-form-field">
            <input
                type="text"
                name="pretty_grid_twitter_username"
                placeholder="<?php esc_attr_e( 'Enter your twitter username here', Pretty_Grid::DOMAIN ); ?>"
                value="<?php if(isset($settings['pretty_grid_twitter_username'])){echo $settings['pretty_grid_twitter_username'];}?>"
                id="pretty_grid_twitter_username"
