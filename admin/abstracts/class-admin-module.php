<?php
/**
 * Pretty_Grid_Admin_Module Class
 *
 * @since  1.0.0
 * @package Auto Mail
 */
...
if ( ! class_exists( 'Pretty_Grid_Admin_Module' ) ) :

abstract class Pretty_Grid_Admin_Module {
	...
	/**
	 * Pretty_Grid_Admin_Module constructor.
	 *
	 * @since 1.0
	 */
